...
.panelset[
.panel[.panel-name[Problem]
A researcher in Nutrition Science is interested in studying the effects of consuming fried food on human's health. To study this issue, this researcher conducted an experiment on 61 pigs which are randomly assigned with .hi-pink[Chips] and .hi-purple2[Non-Chips] diets. Then the levels of different hormones such as urine cortisol, serum cortisol, ACTH and CRH are measured. The researcher wants to know if the Chips diet increases the level of urine cortisol in pigs.
]
