...
- $\color{#20B2AA}{\text{Age}_i}$: age of the $i$-th student (related to *.pink[time since start of treatment]*). 
...
- We notice that for each coefficient $\beta_j$, there is a corresponding p-value is associated to the (Wald t-)test of $H_0: \beta_j = 0$ and $H_a: \beta_j \neq 0$. 
