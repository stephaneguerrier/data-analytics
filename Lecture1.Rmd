...
We have developed an `R` package for this class which is called `idar` (Introduction to Data Analytics with R) and that you can install by running the following code in your `R` console:
