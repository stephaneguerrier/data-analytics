...
.center[
$H_0: \mu_{\text{drug}} \color{#eb078e}{=} \mu_{\text{control}} \ $ and $\ H_a: \mu_{\text{drug}}  \color{#eb078e}{<} \mu_{\text{control}}$.
]
...
$$T = \frac{\sqrt{n} \left(\bar{X}_n - \mu_{H_0}\right)}{\color{#373895}{S}} = \frac{\sqrt{n}\bar{X}_n}{\color{#373895}{S}} \color{#eb078e}{\underset{H_0}{\sim}} G \color{#eb078e}{\approx} \mathcal{N}(0,1),$$
