...
Suppose that the (possibly dependent) data are such that $X_i \sim F_{\color{#eb078e}{i}}, \, i = 1,\ldots, n$ and $\mathbb{E}[X_i] = \mu$. This is a rather a plausible assumption (why? 🤔). To verify our hypothesis (i.e. diet reduces weight) we consider:
...
where $\color{#373895}{S} = \sqrt{ \frac{1}{n-1} \sum_{i = 1}^n (X_i - \bar{X}_n)^2}$ and $\color{#eb078e}{\underset{H_0}{\overset{\cdot}{\sim}}}$ corresponds ".pink[approximately distributed under] $\color{#eb078e}{H_0}$ .pink[as]". In the above formula $T \color{#eb078e}{\underset{H_0}{\overset{ }{\sim}}} G$ ( $\color{#eb078e}{\to} \mathcal{N}(0,1)$, as $n \color{#eb078e}{\to} \infty$) is a random variable but we can compute its .hi-purple[realization] based on our sample, i.e. $\color{#eb078e}{\sqrt{n}\bar{x}_n/s}$.
...
Unlike our previous result, $T$ .pink[follows exactely] (for all $n$) a $\text{Student}(n-1)$ distribution. Note that $\text{Student}(n) \color{#eb078e}{\overset{}{\to}} \mathcal{N}(0,1)$ as $n \color{#eb078e}{\overset{}{\to}} \infty$.
