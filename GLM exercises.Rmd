...
With BIC we obtain a model with only 19 parameters. Now let's check how reliable this model is. We can again compute the in-sample classification accuracy and the out-of-sample classification accuracy.
